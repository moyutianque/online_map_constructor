...
def get_args():
    ...
    # Scene config
    parser.add_argument('--scene_path_template', type=str, default="data/scene_datasets/mp3d/{scene}/{scene}.glb")
    ...
    # VLN annotations
    parser.add_argument('--annt_file', type=str, default="data/vlnce/{split}/{split}.json.gz")
    parser.add_argument('--annt_file_gt_actions', type=str, default="data/vlnce/{split}/{split}_gt.json.gz")
